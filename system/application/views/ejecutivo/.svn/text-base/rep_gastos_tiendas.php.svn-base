...
echo form_open($ruta."/".$ruta."_reportes/rep_gastos_tiendas/", $atrib) . "\n";
...
<table width="100%" class='form_table'>
	...
	<tr>
		...
		<td align="center"><? echo form_radio('tipo','ejecutivo', true);?>Ejecutivo<br />
			<? echo form_radio('tipo','detalle', false);?>Detalle<br /> <? echo form_radio('tipo','desglosado', false);?>Desglosado<br />
		</td>
	</tr>
	<tr>
