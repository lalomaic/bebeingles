...
echo form_open($ruta."/".$ruta."_reportes/rep_comparativo_estacionado_pdf/", $atrib) . "\n";
...
<table width="100%" class='form_table'>
	<tr>
		...
		<th valign="top">Paso No 3 - Elija la Marca y la Cantidad Mínima</th>
	...
	<tr>
		...
		<td align="center"><? echo "<div align=\"center\"><b><input type='hidden' name='cmarca_id' id='cmarca_id' value='' size=\"3\"><input id='marca_drop' class='marca' name='marca_drop' value='' size='30'></b></div>"; ?>
			Cantidad Máxima Vendida <input type='text' name='cantidad_minima'
			value='3' size='4'>
		</td>
	</tr>
	<tr>
