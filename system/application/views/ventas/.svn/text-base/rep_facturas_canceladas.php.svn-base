		...
		<td width="30%" valign="top">
			<table border="1">
				...
				<tr>
					...
					<td colspan="0">Del <?=form_input($fecha1)?> <br />Al <?=form_input($fecha2)?>
					</td>
					<td colspan="0" align="center">Si se deja las fechas en blanco <br>se
						obtienen las ventas canceladas del día de hoy
					</td>
				</tr>
				<tr>
