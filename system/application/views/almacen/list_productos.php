...
echo "<form method='post' accept-charset='utf-8' action=".base_url()."index.php/".$ruta."/".$controller."/".$funcion."/list_productos/1/buscar />";
echo "<table ><tr>";
