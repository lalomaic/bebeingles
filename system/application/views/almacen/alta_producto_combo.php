...
$this->load->view('almacen/js_alta_producto.php');
...
echo form_open($ruta.'/trans/alta_producto_combo', $atrib) . "\n";
...
for($x=1;$x<=1;$x++){
	...
	echo "<tr>
                <td align='right'> 
                    $x <input type='text' name='talla$x' id='talla$x' value='$uni' size='5'> &nbsp;&nbsp;
                </td>
                <td>
...
"<td class='detalle' width=\"400\">
<input type='hidden' name='producto_id$r' id='producto_id$r' value='0' size=\"3\">
<input type='hidden' name='producto_nid$r' id='producto_nid$r' value='0' size=\"3\">";
      echo "<input type='text' id='prod$r' class='prod' value='' size='80'></span></td>".
"<td><input type='text' id='semejanza$r' name='semejanza$r' value='0' size=6><td>".
					"</tr> \n";
		}
		?>
		...
		<tr>
			...
			if(substr(decbin($permisos), 0, 1)==1){
				echo '<button type="button" onclick="javascript:send_detalle()" id="boton_p">Guardar Relacion</button><div id="msg1"></div>';
			}
