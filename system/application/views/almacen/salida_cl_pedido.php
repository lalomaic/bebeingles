...
<div id="subform_detalle">
	...
	<?php
	$r=0;
	if(count($cl_detalle)>0){
		foreach($cl_detalle->all as $linea){
			echo "<p id=\"detail$r\" ><form id=\"fdetail$r\" method=\"post\" name=\"fdetail$r\" action=\"$url_fecha/$r\"><table border=\"1\" width=\"870\" class=\"row_detail_prev\" id=\"table_row$r\"><tr>".
					...
					"<td class='detalle' width=\"150\"><input type=\"text\" name=\"subtotal$r\" size=\"10\" readonly=\"readonly\" value=\"$linea->costo_total\"></td>".
					"</tr></table></form></p>";
			$r+=1;
		}
	}
