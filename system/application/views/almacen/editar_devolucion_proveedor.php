...
<h2><?= $title ?></h2>
<input id="id" type="hidden" value="<?=$devolucion->id?>"/>
<br/>
<fieldset>
    ...
    <table class="form_table" width="100%">
        <tr>
            <td class="form_tag">
                <span>Proveedor</span>
                <input type="text" id="proveedor" value="<?=$devolucion->proveedor_razon_social?>" size="60">
                <input type="hidden" id="proveedor_id" value="<?=$devolucion->proveedor_id?>">
            </td class="form_tag">
        ...
        <tr>
            <td class="form_tag">
                <span>Fecha</span>
                <input id="fecha" class="date_input" type="text" value="<?= $devolucion->fecha?>" />
            </td>
        </tr>
        <tr>
            <td class="form_tag">
                <span>Transporte</span>
                <input id="transporte" class="por-envio" value="<?=$devolucion->transporte?>" type="text" size="60" />
            </td>
        </tr>
        <tr>
            <td class="form_tag">
                <span>Numero de Guia</span>
                <input id="numero_guia" class="por-envio" value="<?=$devolucion->numero_guia?>" type="text" size="60" />
            </td>
        </tr>
        <tr>
            <td class="form_tag">
                <span>Entrega</span>
                <?= form_dropdown("tipo_entraga",$tipos_entrega, $devolucion->tipo_entrega,'class="por-envio" id="tipo_entrega"' ) ?>
            </td>
        </tr>
        <tr>
            <td class="form_tag">
                <span style="vertical-align: top">Domicilio</span>
                <textarea id="domicilio" class="por-envio" cols="51" rows="5"><?=$devolucion->domicilio?></textarea>
            </td>
        </tr>
    </table>
</fieldset>
<fieldset>
    ...
    <table id="productos">
        ...
        <tr>
            <td><input value="<?=$d->codigo_barras?>" type="text" size="20" disabled="disabled" /></td>
            <td><input value="<?=$d->descripcion?>"  type="text" size="55" disabled="disabled" /></td>
            <td><input value="<?=$d->cantidad?>" type="text" size="10" disabled="disabled" /></td>
            <td><input value="<?=$d->precio_compra?>" type="text" size="10" disabled="disabled" /></td>
            <td><input value="<?= $d->precio_compra * $d->cantidad ?>" disabled="disabled" type="text" size="10" /></td>
        </tr>
        <? } ?>
        <? for($i = 0; $i < 500; $i++) {?>
...
<? $this->load->view("almacen/js_editar_devolucion_proveedor") ?>
