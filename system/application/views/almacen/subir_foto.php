...
<body style="width: 100%; text-align: center;">
	...
	<div id="foto" style="width: 100%; text-align: center;">
		<img src="<?=base_url()?><?=$ruta_foto?>" align="center"
			height="150px">
	</div>
	<h3>
	...
	<form id="file_upload"
		action="<? echo base_url();?>index.php/ajax_pet/subir_foto/<?=$producto->id?>"
	...
	<table id="files">
		<!-- 	<tr><td><img src="<?=base_url()?><?=$producto->ruta_foto?>"></td><td></td></tr> -->
	</table>
	<script
...
$(function () {
    $('#file_upload').fileUploadUI({
        ...
        buildDownloadRow: function (file) {
			$('#foto').html('');
			$('#foto').html('<img src="<?=base_url()?>images/productos/'+ file.rutafoto +'" height="150px" align="center">');
