...
$this->load->view('almacen/js_alta_traspaso_plantilla');
//Titulo
echo "<h2>$title</h2>";
//Abrir Formulario
...
echo "<tr><td class='form_tag'><label for=\"ubicacion_entrada_id\">Almac̩n/Tienda a la que solicita el pedido: </label>"; echo form_dropdown('ubicacion_entrada_id', $select2, "$espacios_fisicos->id", "id='ubicacion_entrada_id'");echo "</td><td class='form_input' align=\"right\"><label for=\"cpr_estatus_pedido_id\">Estatus del Pedido: </label>"; echo form_dropdown('cpr_estatus_pedido_id', $select4, "2", "disabled='disabled'"); echo "</td></tr>";
...
echo form_hidden('ubicacion_salida_id', "$ubicacion_salida_id");
