...
function borrar_detalle(line){
    ...
    cl_id=eval("document.fdetail"+line+".cl_detalle_pedido_id"+line+".value");
//    alert(''+cl_id);
    if(cl_id>0){
      $.post("<? echo base_url();?>index.php/ajax_pet/baja_detalle/caso_1", { arg_id1: salida_id, linea: line, arg_id2: cl_id},       //function that is called when server returns a value.
      function(data){
