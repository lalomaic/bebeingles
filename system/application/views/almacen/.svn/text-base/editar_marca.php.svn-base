...
foreach($marca->all as $reg){
	...
	echo form_fieldset('<b>Datos de la Marca del Producto</b>') . "\n";
	...
	echo "<tr><td class='form_tag'><label for=\"estatus\">Estatus de la Marca del Producto:</label></td><td class='form_input'>"; echo form_dropdown('estatus_general_id', $select1, "$reg->estatus_general_id","id='estatus'");echo "</td></tr>";
