<?php
$this->load->view('almacen/js_entrada_por_traspaso.php');
echo "<h2>$title</h2>";
//Abrir Formulario
$atrib = array('name' => 'form1', 'id' => "form1");
echo form_fieldset('<b>Entrada por Traspaso</b>') . "\n";
?>
<div
...
<table class='form_table'>
	<tr>
		<td class="form_tag">Tienda que recibe: <br /> <?=$espaciosf->tag?> <?php echo form_hidden('tienda_id', $espaciosf->id, "id='tienda_id'") ?>
		</td>
	</tr>
</table>
