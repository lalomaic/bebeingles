...
if($traspasos==false){
	...
	foreach($traspasos->all as $row) {
		...
		echo "<tr background=\"$img_row\"><td align=\"center\">$row->id</td><td align=\"center\">$row->fecha_envio</td><td align=\"center\">$row->fecha_recibe</td><td align=\"center\">$row->espacio_envia</td><td align=\"center\">$row->espacio_recibe</td><td align=\"center\">$row->estatus</td><td align=\"center\">$row->usuario</td><td>$pdf</td></tr>";
