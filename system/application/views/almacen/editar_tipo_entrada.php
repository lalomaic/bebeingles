<?php
foreach($tipo_entrada->all as $reg){
	//Inputs
	$tag=array(
			'name'=>'tag',
			'size'=>'40',
	...
	echo form_open($ruta.'/trans/act_tipo_entrada', $atrib) . "\n";
	...
	//Link al listado
	echo "<div align=\"left\"><a href=\"".base_url()."index.php/".$ruta."/".$controller."/".$funcion."/list_tipos_entradas\"><img src=\"".base_url()."images/adduser.png\" width=\"50px\" title=\"Listado de Tipos de Entrada\"></a></div>";
