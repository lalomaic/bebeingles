...
echo  "<a href=\"".base_url()."index.php/".$ruta."/".$controller."/".$funcion."/list_bancos\"><img src=\"".base_url()."images/factura.png\" width=\"30px\" title=\"Listado de Marcas de Productos\">Listado de Bancos</a></div>";
