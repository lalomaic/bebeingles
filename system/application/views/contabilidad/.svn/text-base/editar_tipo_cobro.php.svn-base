...
foreach($tipo_cobro->all as $reg){
	...
	echo form_open($ruta.'/trans/act_tipo_cobro', $atrib) . "\n";
	...
	//Link al listado
	echo "<div align=\"left\"><a href=\"".base_url()."index.php/".$ruta."/".$controller."/".$funcion."/list_tipos_cobros\"><img src=\"".base_url()."images/adduser.png\" width=\"50px\" title=\"Listado de Tipos de Cobro\"></a></div>";
