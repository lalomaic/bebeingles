...
echo form_open($ruta.'/trans/act_gasto_tienda/0', $atrib) . "\n";
...
echo "<tr><td class='form_tag'><label for=\"monto\">Monto del Gasto:</label><br/>"; echo form_input($monto); echo "</td><td class='form_tag' colspan='2'><label for=\"concepto\">Descripción del Gasto:</label><br/>"; echo form_textarea($concepto); echo "</td><td><label for=\"cgastos_id\">Tipo de Gasto:</label><br/>"; echo form_dropdown('ctipo_gasto_id', $tipos_gastos, $row->ctipo_gasto_id, 'id="ctipo_gasto_id"'); echo "</td></tr>";
