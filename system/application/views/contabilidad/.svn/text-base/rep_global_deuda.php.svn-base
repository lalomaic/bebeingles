...
if($subtipos != false){
	foreach($subtipos as $row){
		$y=$row->id;
		$subtipo_select[$y]=$row->tag;
	}
}
$subtipo_select[0]=$default;
$fecha1=array(
		'class'=>'date_input',
		'name'=>'fecha',
		'size'=>'10',
	...
	<tr>
		<td width="30%" valign="top">
			<table border="1">
				...
				<tr>
					<td colspan="0">Subtipo</td>
					<td><?php echo form_dropdown('subtipo',$subtipo_select, 0)?>
					</td>
					<td colspan="2">Mostrar Detalle por Marca<br /> <input type="radio"
						name="desglosado" value='1' checked="checked">Si<input
						type="radio" name="desglosado" value='0' checked="checked">No
					</td>
				</tr>
				<tr>
					<td colspan="0">Espacio Físico</td>
					<td colspan="3"><?php echo form_dropdown('espaciof',$select2, 0)?>
					</td>
				</tr>
				<tr>
