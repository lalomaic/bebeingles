...
foreach($forma_pago->all as $reg){
	...
	echo form_open($ruta.'/trans/act_pr_forma_pago', $atrib) . "\n";
	...
	//Link al listado
	echo "<div align=\"left\"><a href=\"".base_url()."index.php/".$ruta."/".$controller."/".$funcion."/list_pr_formas_pago\"><img src=\"".base_url()."images/adduser.png\" width=\"50px\" title=\"Listado de Formas de Pago\"></a></div>";
}
