...
De cancelar si cambio el mes por error'))
    ...
    function saveDetalle(id) {
        if($('#subcuenta'+id).val() == 0)
            return;
        if(!saved) {
            alert("Primero se deben guardar los cambios de la cabecera, se intentara de manera automutica.\nDespues intente guardar el detalle de nuevo");
            $("#formPoliza").submit();
            return;
        }
        var detalleRow = $('#detalleRow'+id);
    ...
    function update_consecutivo() {
        ...
        $.post(
        '<?php echo site_url("/ajax_pet/get_consecutivo_diario") ?>',
    ...
    <tr>
        <td class="form_buttons" colspan="2" align="right">
            ...
            <div id="saving_poliza">
                <img src="<?php echo base_url() . "images/indicator.gif" ?>" alt="Guardando la póliza" width="16" height="16"/>
                Guardando póliza...
            </div>
            <div id="saved_poliza">
                <img src="<?php echo base_url() . "images/bien16.png" ?>" alt="Póliza guardada" width="16" height="16"/>
                Póliza guardada
            </div>
        </td>
    </tr>
...
<table class="row_detail" style="margin-top: 10px;" id="polizaDetalles">
    <tr>
        ...
        <td>
            ...
            <input type="hidden" name="id" value="" id="detalle_id1"/>
        </td><td>
    ...
    <tr>
        <th class="detalle_pie" colspan="6">
            ...
            <button type="button" onclick="salida('contabilidad/poliza_c/formulario/list_polizas_diario');">Ir al listado</button>
            <button type="button" onclick="salida('contabilidad/poliza_c/formulario/alta_manual_poliza_diario');">Generar otra póliza</button>
    </tr>
</table>