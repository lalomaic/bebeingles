...
echo form_open($ruta."/".$ruta."_reportes/rep_ventas_empleado_gral_pdf/", $atrib) . "\n";
...
<table width="100%" class='form_table'>
	<tr>
		<td valign="top" width="200">
			<table border="1">
				<tr>
					<th colspan="4">Paso No 1 - Filtrar Sucursales
					</th>
				</tr>
				<tr>
					<td colspan="3">
						<?php echo form_dropdown('espacio_fisico_id', $select2, 0);?></td>
				</tr>
				<tr>
					<th colspan="4">Periodo de Tiempo</th>
				</tr><tr>
					<td colspan="0">Fecha inicio: </td><td colspan="3"><?php echo form_input($fecha1);?></td>
				</tr><tr>
					<td colspan="0">Fecha final</td><td colspan="3"><?php echo form_input($fecha2);?></td>
				</tr><tr>
