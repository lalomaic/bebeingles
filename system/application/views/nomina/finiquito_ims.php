...
<table style="margin-top:20px; table-layout: fixed; font-size: 11pt;  border: .5px solid #ccc;" width="510" id="table_tcp">

 <tr>
 <td width="17%"></td>
	<td width="17%">Categoria: </td>
	<td align="17%"></td>
	<td align="right" width="30%"><?php echo $puesto ?></td> 
	<td align="17%"></td>
	 </tr>
...
<td width="17%"></td>
<td width="17%" align="right"> <?php  echo $fecha_ingreso ?> </td>
<td width="17%"></td>
</tr>
...
<td> Fecha de Baja: </td>
<td></td>
<td align="right"> <?php  echo $fecha_baja ?> </td>
<td></td>
</tr>

<tr>
<td></td>
<td> Salario Diario: </td><td></td>
<td align="right"><?php  echo $salario ?></td><td></td>
</tr> 
</table>
<br>
...
<table style="table-layout: fixed; font-size: 11pt;  vertical-align: middle; " width="510" id="table_tcp">
  <tr>
<td  valign="top" class="izquierda">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RECIBÍ: de <?php  echo $razon_social ?> , en cuanto propietario y responsable de la fuente de trabajo ubicada en la calle <?php  echo $calle ." Num. Interior ".$num_int ." Num. Exterior ". $num_ext ." Colonia ". $colonia ." de la ciudad de ". $localidad ?> ,comercialmente conocida como <?php echo '"'. $espacio_tag .'"' ?>, la cantidad de: <?php echo $total ." (". $letra .")" ?> ,por concepto de pago de 
diversas prestaciones generadas durante la Relación de Trabajo, y como finiquito de la misma por terminación de mutuo consentimiento, en términos del artículo 53 fracción I de la Ley Federal del Trabajo, cuantificadas conforme a los siguientes datos generales, que constituyen las últimas condiciones de trabajo a las que estuve sujeta.
<br><br>
</td>
</tr>
</table>
<table style="font-size: 11pt; border: .5px solid #ccc;" width="500">
 <tr>
 <td width="17%"></td>
	<td width="17%">Categoria: </td>
	<td align="17%"></td>
...
<td width="30%"> Fecha de Ingreso: </td>
<td width="17%"></td>
	<td width="17%" align="rigth"> <?php  echo $fecha_ingreso_imss ?> </td>
<td width="17%"></td>
</tr>
  <tr>
<td></td>
	<td> Fecha de Baja: </td><td></td>
	<td align="right"> <?php  echo $fecha_baja ?> </td>
<td></td>	
	</tr>
...
<td></td>
	...
	<td></td>
	<td align="right"><?php  echo "$ ".$salario_im ?></td>
	<td></td>
  </tr> 
</table>

<br>
<table style="margin-top:20px; margin-left:70px; table-layout: fixed; font-size: 11pt; text-align: left; align: center; border: .5px solid #ccc;" width="500" id="table_tcp">
  <tr>
  <td></td>
	<td><b>Prestaciones:</b> </td><td></td><td align="right"><b>Cantidades</b></td><td></td> 
	 </tr>
	 
<tr>
<td></td>
<td>Aguinaldo: </td><td></td>
	<td align="right"><?php  echo $aguinaldo_i ?> </td><td></td>
</tr>

  <tr>
  <td></td>
	<td>Vacaciones: </td><td></td>
	<td align="right"><?php  echo $vacaciones_i ?> </td><td></td>
	</tr>

<tr>
<td></td>
	<td>Prima Vacacional: </td><td></td>
	<td align="right"><?php  echo $pri_vacacional_i ?></td><td></td>
  </tr>
  <tr>
  <td></td>
	<td>Total A recibir: </td><td></td>
	<td align="right"><?php  echo $total_i ?></td>
	<td></td>
  </tr>
</table>
<br>
...
Cantidad que se me cubre en este mismo acto y a mi más entera satisfacción. Declarando para los efectos legales correspondientes, que otorgo a <?php  echo $empleado ?> , el más amplio finiquito de obligaciones en los términos de la Ley Federal del Trabajo, por concepto de sueldos ordinarios, séptimos días, días de descanso obligatorio, 
horas extras, vacaciones, prima vacacional, aguinaldo, así como cualquiera otra prestación legal o contractual, manifestando que no contraje enfermedad profesional alguna durante el tiempo laborado, y no me reservo acción, ni derecho de ninguna naturaleza que ejercen en su contra o de sus representantes así como de quien resulte responsable de la 
fuente de trabajo calle <?php  echo $calle ." Num. Interior ".$num_int ." Num. Exterior ". $num_ext ." Colonia ". $colonia ." de la ciudad de ". $localidad ?> o
 de sus sucursales en el Estado o en la República Mexicana. <br>
 <p align="right">Morelia, Michoacán a <?php echo $fecha1 ?>.</p>.<br><br><br><br>
</td>
</tr>
<tr style="width:20%" align="center">
<td>
