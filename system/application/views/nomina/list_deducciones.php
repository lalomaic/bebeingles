...
<div align="left">
	<a href="<?php echo site_url('/'.$ruta.'/'.$controller.'/formulario/alta_deduccion')?>" title="Nueva prestación">
...
foreach($deducciones as $deduccion)
	...
	if(substr(decbin($permisos), 2, 1)==1)
		$link_edit='<a href="'.site_url("/$ruta/$controller/$funcion/$subfuncion/editar_deduccion/".$deduccion->id).'" title="editar"><img src="'.$img_edit.'" height="25px" width="25px"></a>';
