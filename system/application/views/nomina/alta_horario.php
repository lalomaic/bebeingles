...
# entrada
$entrada_h=form_dropdown('entrada_h', $opts_h,'09');
$entrada_m=form_dropdown('entrada_m', $opts_m,0);
# salida
$salida_h=form_dropdown('salida_h', $opts_h,'17');
$salida_m=form_dropdown('salida_m', $opts_m,0);
//Titulo
echo "<h2>$title</h2>";
//Load validacion
