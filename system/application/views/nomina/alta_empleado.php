...
<?php echo form_open($ruta . '/empleado_c/alta_empleado', array('name' => 'form1', 'id' => 'form1'));
    echo form_fieldset('<b>Datos del empleado</b>');?>
        ...
        <table width="80%" class='form_table'>
            ...
            <tr>
                ...
                <td class='form_tag'>Espacio físico:<br/><?php echo form_dropdown('espacio_fisico_id', $espacios, 0, "id='espacio_fisico_id'"); ?></td>
                <td class='form_tag'>Puesto:<br/><?php echo form_dropdown('puesto_id', $puestos, 0, "id='puesto_id'"); ?></td>
            </tr>
            <tr>
                <td class='form_tag'>Salario:</td>
                <td class="form_input"><?php echo form_input($salario); ?></td>
            ...
            <tr>
                <td class='form_tag'>Tipo Comisión:</td>
                <td class="form_input">
					<? echo form_dropdown('comision_id', $comisiones, 0, 'id="comision_id"');?>
                </td>
				<td class='form_tag'>Factor Descuento INFONAVIT:<br/><?php echo form_input($valor_descuento_infonavit); ?>
                </td>
                <td class='form_tag'>Zona:<br/><? echo form_dropdown('smg_zona_id', $zonas, 0, 'id="smg_zona_id"');?>
                </td>
            </tr>
            <tr>
