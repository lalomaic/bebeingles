    ...
    $(document).ready(function(){
        ...
        $(".filtros").change(function(){ 
            ...
            if($("#inactivos").is(":checked"))
                ...
                showin = "notshowin";
            window.location='<?php echo base_url(); ?>index.php/nomina/empleado_c/formulario/list_empleados/' + $(this).attr('id') + '/' + $(this).val();
        });
...
<table  class="listado" border="0">
    ...
    if (substr(decbin($permisos), 1, 1) == 1)
        $link_del = '<a class="modal_upload" href="'.site_url("/$ruta/$controller/$funcion/$subfuncion/borrar_empleado/__id__").'" title="Deshabilitar empleado"><img src="' . $img_del . '" height="25px" width="25px"/></a>';
