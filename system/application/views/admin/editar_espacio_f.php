...
echo "<tr><td class='form_tag'><label for=\"empresas_id\">Empresa:</label><br/>"; echo form_dropdown('empresas_id', $select1, "$line->empresas_id","id='empresa'");echo "</td><td class='form_tag'><label for=\"tipo_espacio_id\">Tipo de Local: </label><br/>"; echo form_dropdown('tipo_espacio_id', $select2,"$line->tipo_espacio_id","id='tipo_espacio'");echo "</td><td class='form_tag'><label for=\"subtipo_espacio_id\">Subtipo de Local: </label><br/>"; echo form_dropdown('subtipo_espacio_id', $select2s,"$line->subtipo_espacio_id","id='subtipo_espacio'"); echo "</td></tr>";
...
echo "<tr><td class='form_tag'><label for=\"espacio_fisico_matriz_id\">Matriz del Espacio Físico actual:</label><br/>"; echo form_dropdown('espacio_fisico_matriz_id', $matriz, "$line->espacio_fisico_matriz_id","id='espacio_fisico_matriz_id'"); echo "</td><td class='form_tag'><label for=\"rfc\">R.F.C.:</label><br/>"; echo form_input($rfc); echo "</td></tr>";


echo "<tr><td class='form_tag'></td></tr>";
