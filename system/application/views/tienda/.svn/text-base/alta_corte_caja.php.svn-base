...
echo "<tr><td class='form_tag'><label for=\"empresas_id\">Empresa contratante:</label></td><td class='form_input'>"; echo form_dropdown('empresas_id', $select1);echo "</td><td class='form_tag'><label for=\"espacios_fisicos_id\">Espacio F�sico asignado: </label></td><td class='form_input'>"; echo form_dropdown('espacio_fisico_id', $select2);echo "</td></tr>";
