...
//       }
  ...
  document.getElementById("fin").innerHTML='<br><p><a href="<? echo base_url();?>index.php/almacen/almacen_reportes/rep_pedido_traspaso/'+id+'"  target="_blanck" class="modal_pdf"/><img src="<? echo base_url();?>images/adobereader.png" width="32"/>Orden de Traspaso</a></p>';
}
