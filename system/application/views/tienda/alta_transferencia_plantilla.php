...
<div id="subform_detalle">
	<table width="700" class="row_detail_pred" id="header">
		...
		for($r;$r<$productos;$r++){
			...
			echo "<tr id=\"row$r\"  class=\"$class\" ><td  class='detalle' width=\"50\" align=\"center\">". ($r+1) .".<form id=\"fdetail$r\" method=\"post\" name=\"fdetail$r\" action=\"$url_form/$r\"><button type=\"submit\" id=\"b$r\" style=\"display:none;\">Guardar Registro</button><div id=\"content$r\">"; echo form_hidden("id$r", '0');  echo form_hidden("producto$r", "$productos->cproducto_id"); echo form_hidden("cl_pedidos_id$r", "0"); echo "</div></td>".

					"<td class='detalle' width=\"30\">$productos->descripcion $productos->presentacion </td>".

					"<td class='detalle' width=\"30\"><input type=\"text\" name=\"unidades$r\" size=\"4\" value='0' id=\"cantidad$r\" class=\"cantidad\"></form></td>".
