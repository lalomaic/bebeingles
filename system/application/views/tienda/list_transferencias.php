...
echo "<a href=\"".$baseLinks."/list_salida_traspasos\" title=\"Listado de traspasos enviados\"><img src=\"".base_url()."images/factura.png\" width=\"25px\"  > Entradas enviadas </a></div>";

echo "<div align=\"center\"><b>Total de registros:".$total_registros."</b></div>";

//Botones de Edicion
$img_row = "".base_url()."images/table_row.png";
$photo = "<img src=\"".base_url()."images/edit.png\" width=\"25px\" title=\"Detalles de Traspaso\" border=\"0\">";
$edit_url = base_url()."index.php/almacen/almacen_reportes/rep_pedido_traspaso/";
