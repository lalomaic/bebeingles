...
echo "<th>Seleccione las sucursales que desea relacionar a la plantilla de Stock actual<br/>Si la sucursal esta relacionada a otra plantilla, automaticamente se le asignar� la actual</th>";
$n=0;
