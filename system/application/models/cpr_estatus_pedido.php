 ...
 * @link
 */
class Cpr_estatus_pedido extends DataMapper {

	var $table= "cpr_estatus_pedidos";


	function  Cpr_estatus_pedido($id=null)
	{
	 ...
	 * @return	bool
	 */
	function get_cpr_estatus_all()
	{
		// Create a temporary user object
		$e = new Cpr_estatus_pedido();
	...
	function get_cpr_estatus_list($offset, $per_page)
	{
		// Create a temporary user object
		$u = new Cpr_estatus_pedido();
